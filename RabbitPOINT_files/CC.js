...
お手数をおかけして恐縮ですが、お届けした商品の写真をお送りいただけますでしょうか。
...
このたびは数量不足があり、誠に申し訳ございません。
確認いたしましたところ、倉庫での梱包ミスにより、〇〇（漏发的东西）が未発送となっておりました。

現在お手元には、〇〇（到达的东西）が届いている状況でお間違いないでしょうか。

不足分の〇〇（漏发的东西）は至急再発送させていただきます。
...
現在お手元には、〇点のみ届いている状況でお間違いないでしょうか。
●

また、不足分につきましては、下記商品〇点が未着という認識でよろしいでしょうか。
●

不足分は月曜日に至急再発送させていただきます。
...
このたびは商品に誤りがあり、誠に申し訳ございません。
確認いたしましたところ、倉庫での梱包ミスにより、〇〇ではなく〇〇を発送してしまっておりました。

現在お手元には、〇〇が届いている状況でお間違いないでしょうか。

正しい商品である〇〇は至急再発送させていただきます。
...
分割発送につきましては、誠に恐れ入りますが、当店では1つのご注文番号につき1件の発送とさせていただいておりますため、個別での発送は承っておりません。
そのため、別々にご購入いただいた場合は個別発送が可能ですが、同一注文内での分割発送はできかねます。何卒ご理解いただけますと幸いです。
...
よろしくお願いいたします。`
  ...
  {
    title: "【出荷済みの・キャンセルできず】",
    content: `大変申し訳ございませんが、こちらで確認いたしましたところ、ご注文の商品はすでに出荷済みとなっており、現在キャンセルを承ることができません。

商品がお手元に届きましたら、未使用の状態に限り返品対応も可能でございますので、その際はお手数ですがご連絡いただけますと幸いです。

この度はご希望に添えず申し訳ございませんが、何卒よろしくお願いいたします。`
  },  
  {
    title: "【GPT：楽天評価】",
